...
import { generatePipelineRuns } from './pipeline-runs';
...
export function generateCatalogData(): CatalogData {
  ...
  const pipelineRuns = generatePipelineRuns(40, datasetIds);
  ...
  return { datasets, dataSources, lineage, pipelineRuns, qualityChecks, costs };
}
